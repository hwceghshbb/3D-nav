...
def generate_launch_description():
    ...
    depth_policy_file = os.environ.get("BXI_DEPTH_POLICY_FILE", "")
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument("scan_planning_horizon", default_value="3.5"),
        ...
        DeclareLaunchArgument("scan_max_vyaw", default_value="0.45"),
        Node(
            package="mujoco",
            ...
            parameters=[
                {
                    ...
                    "enable_clearance_cost": ParameterValue(
                        LaunchConfiguration("octo_enable_clearance_cost"), value_type=bool
                    ),
                    "clearance_cost_radius_cells": ParameterValue(
                        LaunchConfiguration("octo_clearance_cost_radius_cells"), value_type=int
                    ),
                    "clearance_cost_weight": ParameterValue(
                        LaunchConfiguration("octo_clearance_cost_weight"), value_type=float
                    ),
                    "odom_topic": "/simulation/base_footprint/pose",
                    "goal_topic": "/move_base_simple/goal",
                    ...
                    "enforce_path_ground_clearance": ParameterValue(
                        LaunchConfiguration("octo_enforce_path_ground_clearance"), value_type=bool
                    ),
                    "path_min_ground_clearance": ParameterValue(
                        LaunchConfiguration("octo_path_min_ground_clearance"), value_type=float
                    ),
                    "path_ground_search_depth": ParameterValue(
                        LaunchConfiguration("octo_path_ground_search_depth"), value_type=float
                    ),
                    "path_ground_xy_radius_cells": ParameterValue(
                        LaunchConfiguration("octo_path_ground_xy_radius_cells"), value_type=int
                    ),
                    "publish_map": True,
