...
setup(
    ...
    entry_points={
        "console_scripts": [
            ...
            "localization_benchmark = bxi_cuvslam_localization.localization_benchmark:main",
            "localization_benchmark_motion = bxi_cuvslam_localization.benchmark_motion:main",
            "sim_imu_specific_force = bxi_cuvslam_localization.sim_imu_specific_force:main",
            "benchmark_rgbd_camera_publisher = bxi_scan_nav.rgbd_camera_publisher:main",
            "nav_camera_frame_trigger = bxi_scan_nav.camera_frame_trigger:main",
            "nav_rgbd_camera_publisher = bxi_scan_nav.rgbd_camera_publisher:main",
            "navigation_command_bridge = bxi_cuvslam_localization.navigation_command_bridge:main",
