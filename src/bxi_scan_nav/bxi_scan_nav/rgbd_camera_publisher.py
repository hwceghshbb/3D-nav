...
class RgbdCameraPublisher(Node):
    def __init__(self):
        ...
        self.rgb_pub = self.create_publisher(Image, output + "color/image_raw", image_qos)
        self.depth_pub = self.create_publisher(Image, output + "depth/image_raw", image_qos)
    ...
    def publish(self):
        ...
        self.depth_pub.publish(self.image(depth, "32FC1", stamp, self.width * 4))
        info = CameraInfo()
